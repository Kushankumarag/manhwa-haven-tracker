...
export const TitleCard: React.FC<Props> = ({
  ...
  return (
    <div className="bg-card rounded-xl shadow-md flex flex-col h-full hover:scale-[1.015] hover:shadow-lg transition p-3">
      {/* Cover image */}
      <div
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="rounded px-2 py-0.5 text-xs font-semibold bg-muted text-muted-foreground">
          {title.status}
        </span>
      ...
      <div className="flex gap-2 mt-auto">
        <button
          className="rounded-md bg-card hover:bg-muted text-foreground px-2 py-1"
          title="Add 1 Chapter"
        ...
        <button
          className={`rounded-md ${title.isFavorite ? "bg-[#ffd600] text-black" : "bg-card text-foreground"} hover:bg-[#ffd600] hover:text-black px-2 py-1`}
          title="Favorite"
        ...
        <button
          className="rounded-md bg-secondary hover:bg-muted text-foreground px-2 py-1"
        ...
        <button
          className="rounded-md bg-destructive hover:bg-red-800 text-destructive-foreground px-2 py-1"
          title="Delete"
          onClick={onDelete}
        >
          Delete
